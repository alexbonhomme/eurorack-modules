...
const static float voctpow[1230] PROGMEM = {
    // V.oct table
    0,
    0.004882,
    0.009765,
...
void loop()
{
  ...
  case 0: // LFO
    ...
    for (int j = 0; j < 10; j++)
    { // To improve the reading accuracy, measure multiple times .
      freq += (analogRead(1) + analogRead(7)) / 32 + 1;
    }
    freq = freq / 10;
    //      freq = min(1023, freq);
    LED = analogRead(3) / 4;
  ...
  case 1: // tempo
    ...
    for (int j = 0; j < 10; j++)
    { // To improve the reading accuracy, measure multiple times .
      freq += (analogRead(1) + analogRead(7)) / 8 + 10;
    }
    freq = freq / 10;
    //      freq = min(1023, freq);
    LED = analogRead(3) / 4;
